...
4. Restreams input data and scores to mongo and/or Bokeh server
"""
...
from .restream.mongo import init_mongo
from .restream.mongo import upload_dataframe
...
def threaded_restream_dataframe(dataframe, sensors, detector, timefield,
    ...
    """ Restream dataframe to bokeh and/or mongo """
    ...
    for batch in batches:
        ...
        while end_time < np.max(batch[timefield]):
            ...
            if es_conn: # Stream batch to mongo
